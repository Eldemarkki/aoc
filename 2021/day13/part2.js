...
// Map these points in Excel or something
require("fs").writeFileSync("out.txt", Buffer.from(points.map(point => [point[0], -point[1]]).join("\n").replaceAll(",", ";").toString()))

console.log("Map the points in out.txt in Excel or something to see the letters")